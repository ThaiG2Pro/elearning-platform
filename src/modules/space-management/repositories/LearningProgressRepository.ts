...
export class LearningProgressRepository {
    ...
    private toDomain(progress: {
        id: bigint; user_id: bigint; space_id: bigint;
    ...
    /** All progress rows for a user across a space's lessons — used to compute completion %. */
    async findByUserAndSpace(userId: bigint, spaceId: bigint): Promise<LearningProgress[]> {
