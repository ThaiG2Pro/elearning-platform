                ...
                <>
                    ...
                    <div className="absolute right-0 mt-2 w-52 bg-ink-panel rounded-ink-md shadow-lg border border-ink-border z-20 overflow-hidden">
                        ...
                        <div className="py-1.5" role="menu">
                            ...
                            {/* 2026-09-06 — "Space đang học" + "Space đã tạo" gộp thành 1
                                mục duy nhất (xem "quy hoạch /my-learning vs /my-spaces"):
                                2 trang đọc CÙNG 1 tập space sở hữu, chỉ khác annotate, nay
                                là 1 danh sách duy nhất tại /my-learning. */}
                            <button onClick={() => go('/my-learning')} role="menuitem"
                                className="flex items-center gap-2.5 px-4 py-2 text-sm text-ink-text hover:bg-ink-page w-full text-left transition-colors">
                                <svg className="w-4 h-4 text-ink-textMuted" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"/></svg>
                                Space của tôi
                            </button>
                            {/* 2026-09-05 — "Link chia sẻ của tôi" + "AI đã chia sẻ của tôi"
                                gộp thành 1 mục duy nhất (xem audit "cơ cấu lại khu vực quản lý
                                chia sẻ"): 2 domain (link Space / bản AI share bằng BYOK) giờ là
                                2 tab trong cùng trang /my-shares, không còn 2 điểm chạm rời. */}
                            ...
                            <button onClick={handleLogoutClick} role="menuitem"
                                className="flex items-center gap-2.5 px-4 py-2 text-sm text-destructive hover:bg-destructive/10 w-full text-left transition-colors">
                                <svg className="w-4 h-4 text-destructive" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1"/></svg>
                                Đăng xuất
                            </button>
                        </div>
                    </div>
