    ...
    if (!courses || courses.length === 0) {
        return (
            <div className="flex flex-col items-center justify-center py-16 text-center">
                ...
                <h3 className="text-base font-semibold text-slate-700 mb-1">Không có khóa học</h3>
                <p className="text-sm text-slate-500 max-w-xs">Hiện tại chưa có khóa học phù hợp. Hãy thử thay đổi từ khóa tìm kiếm.</p>
            </div>
        );
    }
