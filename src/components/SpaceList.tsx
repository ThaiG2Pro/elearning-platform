...
function SpaceCardSkeleton() {
    return (
        <div className="bg-ink-panel rounded-ink-md border border-ink-border overflow-hidden animate-pulse">
            <div className="w-full aspect-video bg-ink-page" />
            <div className="p-4 space-y-2.5">
                <div className="h-4 bg-ink-page rounded-md w-4/5" />
                <div className="h-3 bg-ink-page rounded-md w-3/5" />
                <div className="h-3 bg-ink-page rounded-md w-2/5" />
            </div>
        </div>
    );
}
    ...
    if (!spaces || spaces.length === 0) {
        return (
            <div className="flex flex-col items-center justify-center py-16 text-center">
                <div className="w-16 h-16 rounded-full bg-ink-page flex items-center justify-center mb-4">
