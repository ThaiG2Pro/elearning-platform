                                            ...
                                            <div className="border-t border-ink-pageDim pt-6">
                                                ...
                                                <div className="flex gap-2">
                                                    ...
                                                    <Button
                                                        ...
                                                        className="flex-1"
                                                    >
                                                        {aiLoading === 'quiz' ? 'Đang tạo quiz…' : (aiQuizDraft ? 'Tạo quiz lại' : 'AI tạo quiz cho bài này')}
                                                    </Button>
                                                </div>
                                                ...
                                                {(() => {
                                                    ...
                                                    return (
                                                        <div>
                                                            ...
                                                            <div className="mb-2">
                                                                <VideoSourceDropdown
                                                                    options={videoCandidates.map(l => ({
                                                                        sourceId: l.sourceId,
                                                                        label: multiChapter ? `${l.chapterTitle} › ${l.title}` : l.title,
                                                                    }))}
