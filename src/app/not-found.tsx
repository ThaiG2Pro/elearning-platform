...
export default function NotFound() {
    return (
        <div className="min-h-screen bg-ink-page flex flex-col items-center justify-center px-4 text-center">
            <div className="w-16 h-16 rounded-full bg-ink-panel flex items-center justify-center mb-4">
                <svg className="w-8 h-8 text-ink-textMuted" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9.172 16.172a4 4 0 015.656 0M9 10h.01M15 10h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
            </div>
            <h1 className="text-2xl font-bold text-ink-text mb-2">Không tìm thấy trang</h1>
            <p className="text-sm text-ink-textMuted mb-6 max-w-sm">
