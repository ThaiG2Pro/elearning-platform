    ...
    return (
        <div className="min-h-screen bg-ink-page">
            ...
            <main className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-7 md:py-10">
                ...
                {/* 2026-09-05 — trang này quản lý link chia sẻ CẤP SPACE, khác hẳn
                    /my-ai-shares (bản AI/quiz share bằng BYOK) — 2 trang trước đây
                    không biết nhau tồn tại dù cùng chủ đề "chia sẻ của tôi". */}
                <button
                    onClick={() => router.push('/my-ai-shares')}
                    className="block text-xs font-medium text-ink-accent hover:text-ink-accent/80 underline underline-offset-2 mb-6"
                >
                    Đang tìm bản AI (quiz/tóm tắt) bạn đã chia sẻ? Xem tại đây →
                </button>
