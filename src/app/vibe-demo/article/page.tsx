      ...
      {([
        ...
        return (
          <button
            ...
            className={`flex-1 flex items-baseline justify-center gap-1.5 py-3 px-2 bg-none cursor-pointer border-0 border-b-2 text-sm transition-colors [transition-duration:120ms] ${
  ...
  return (
    <div className={beVietnam.className}>
      ...
      <div
        ...
        className={`fixed top-0 left-0 right-0 z-50 flex items-center gap-2 px-7 text-[12.5px] transition-[background,border-color,color] [transition-duration:600ms] ease-in-out ${
          focusMode
      ...
      <div
        style={{ top: TOP_BAR_H }}
        className={`fixed left-0 right-0 bottom-0 z-[1] flex justify-center transition-[background] [transition-duration:600ms] ease-in-out ${focusMode ? 'bg-ink-room' : 'bg-ink-page'}`}
      >
        <div
