                            ...
                            <div className="flex flex-wrap items-center gap-4 mb-4">
                                {course.ownerName && (
                                    <p className="text-sm text-ink-textMuted">
                                        Tác giả: <span className="font-medium text-ink-text">{course.isOwner ? 'Bạn' : course.ownerName}</span>
                                    </p>
                                )}
                            </div>
                            {course.description && (
                                <p className="text-sm text-ink-textMuted leading-relaxed">{course.description}</p>
                            )}
                            {course.isOwner && typeof course.completionRate === 'number' && (
                                <div className="mt-4">
                                    <div className="flex items-center justify-between text-xs text-ink-textMuted mb-1">
                                        ...
                                        <span className="font-medium text-ink-textMid">{course.completionRate}%</span>
                                    </div>
