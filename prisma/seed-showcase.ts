 ...
 * database that already has real users and courses in it — running it twice
 * does not duplicate anything.
 *
 * Content choice: 5 real, popular, free full-course videos (verified via
...
const SHOWCASE_COURSES = [
    {
        slug: 'showcase-java-full-course',
        title: 'Nhập môn Java — Full Course',
        description:
            'Java Full Course for free ☕ — Bro Code. Playlist showcase công khai, dựng từ video full-course thật.',
        videoUrl: 'https://www.youtube.com/watch?v=xTtL8E4LzTQ',
        videoTitle: 'Java Full Course for free ☕',
    },
    {
        slug: 'showcase-cpp-full-course',
        title: 'Nhập môn C++ — Full Course',
        description:
            'C++ Full Course for free ⚡️ — Bro Code. Showcase công khai, dựng từ video full-course thật.',
        videoUrl: 'https://www.youtube.com/watch?v=-TkoO8Z07hI',
        videoTitle: 'C++ Full Course for free ⚡️',
    },
    {
        slug: 'showcase-python-full-course',
        title: 'Nhập môn Python — Full Course',
        description:
            'Learn Python - Full Course for Beginners [Tutorial] — freeCodeCamp.org. Showcase công khai.',
        videoUrl: 'https://www.youtube.com/watch?v=rfscVS0vtbw',
        videoTitle: 'Learn Python - Full Course for Beginners [Tutorial]',
    },
    {
        slug: 'showcase-javascript-full-course',
        title: 'Nhập môn JavaScript — Full Course',
        description: 'JavaScript Programming - Full Course — freeCodeCamp.org. Showcase công khai.',
        videoUrl: 'https://www.youtube.com/watch?v=jS4aFq5-91M',
        videoTitle: 'JavaScript Programming - Full Course',
    },
    {
        slug: 'showcase-html-css-full-course',
        title: 'Nhập môn HTML & CSS — Full Course',
        description:
            'Learn HTML5 and CSS3 From Scratch - Full Course — freeCodeCamp.org. Showcase công khai.',
        videoUrl: 'https://www.youtube.com/watch?v=mU6anWqZJcc',
        videoTitle: 'Learn HTML5 and CSS3 From Scratch - Full Course',
    },
];
...
async function main() {
    ...
    for (const item of SHOWCASE_COURSES) {
        const existing = await prisma.courses.findUnique({ where: { slug: item.slug } });
        if (existing) {
        ...
        const course = await prisma.courses.create({
            data: {
                ...
                is_showcase: true,
                // WP1.10.1 — course sinh từ nguồn nào, cùng ngữ nghĩa với
                // from-link flow thật.
                source_id: source.id,
            },
        });
        ...
        const chapter = await prisma.chapters.create({
            data: { course_id: course.id, title: item.videoTitle, order_index: 1 },
        });
        ...
        console.log(`✅ Created showcase course: ${item.title}`);
    }
